...
const devices = [
  ...
  },
  {
    icon: Smartphone,
    brand: "Samsung",
    models: ["Galaxy S24 Ultra", "Galaxy S24+", "Galaxy S24", "Galaxy S23 Ultra", "Galaxy S23", "Galaxy A54", "Galaxy A34", "Galaxy A14"],
  },
  {
    icon: Smartphone,
    brand: "Xiaomi",
    models: ["Xiaomi 14 Ultra", "Xiaomi 14", "Redmi Note 13 Pro", "Redmi Note 13", "Redmi 13C", "POCO X6 Pro", "POCO F5"],
  },
  {
    icon: Smartphone,
    brand: "Huawei",
    models: ["P60 Pro", "P50 Pro", "Mate 50 Pro", "Nova 11", "Nova 10", "Y9 Prime"],
  },
  {
    icon: Smartphone,
    brand: "Oppo / Realme",
    models: ["Oppo Reno 10 Pro", "Oppo A78", "Oppo A58", "Realme 11 Pro", "Realme C55", "Realme C53"],
  },
  {
    icon: Tablet,
    brand: "Tablet Tamiri",
    models: ["iPad Pro", "iPad Air", "iPad Mini", "Samsung Galaxy Tab S9", "Galaxy Tab A9", "Xiaomi Pad 6"],
  },
  {
    icon: Watch,
    brand: "Akıllı Saat",
    models: ["Apple Watch Ultra", "Apple Watch Series 9", "Samsung Galaxy Watch 6", "Huawei Watch GT4"],
  },
  {
    icon: Headphones,
    brand: "Kulaklık / Aksesuar",
    models: ["AirPods Pro", "AirPods 3", "Galaxy Buds", "JBL", "Sony WH-1000XM5"],
  },
];
